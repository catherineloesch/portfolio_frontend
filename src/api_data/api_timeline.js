...
const timelineData = [
  {
    ...
    description: [
      ...
      "SQL + NoSQL databases, third-party API integration",
      "individual + group projects, pair-programming, git/GitHub collabotation",
    ],
  },
  {
    id: 2,
...

  {
    ...
    description: [
      ...
      "study of paramyxovirus and coronavirus shedding in bats to understand inter-species transmission",
      "training: RNA extraction, purification, real-time PCR, gel electrophoresis",
    ],
  },
  {
    id: 4,
